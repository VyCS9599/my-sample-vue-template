...
const companyName = "Y4Tech";
const subTitle = "The best in kuching.";
</script>
...
<template>
  ...
  <main>
    <section>
      ...
      >
        <div class="flex flex-col items-center mx-auto text-center">
          ...
          <p class="mt-6 text-lg leading-5 text-white">{{subTitle}}</p>
    ...
    <section class="container px-6 py-8 mx-auto lg:py-16" id="portfolio">
      <div
        class="grid grid-cols-1 gap-8 xl:gap-12 md:grid-cols-2 xl:grid-cols-3"
      >
    ...
    <section class="container px-6 py-8 mx-auto lg:py-16" id="blog">
      <h3 class="text-xl font-medium text-gray-800 md:text-2xl lg:text-3xl">
        Recent Blog Posts
      </h3>
      ...
      >
        <div>
          ...
          <a
            href="#"
            class="inline-block mt-4 text-indigo-500 underline hover:text-indigo-400"
            >Read more</a
          >
        </div>
  ...
  <footer class="flex flex-col items-center py-20 text-white bg-gray-900">
    <p class="text-center">Copyright © {{ currentYear }}, {{ companyName }}</p>
